...
```
cd existing_repo
git remote add origin https://gitlab-ea.beigenecorp.net/dsoe_si/beone-projects/beone.aimta.server.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-ea.beigenecorp.net/dsoe_si/beone-projects/beone.aimta.server/-/settings/integrations)
